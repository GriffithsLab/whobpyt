...
from whobpyt.datasets.generators import gen_cube
...
randTS1 = Timeseries(randData1, step_size)
randTS2 = Timeseries(randData2, step_size)

# call model fit
F = ModelFitting(model, ObjFun, device = device)
